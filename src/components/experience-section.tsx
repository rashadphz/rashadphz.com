  ...
  return (
    <div className="">
      ...
      <Accordion className="w-full mt-3 space-y-2" type="single" collapsible>
        {experiences.map(({ company, role, location, duration, description, tools }) => (
          <AccordionItem 
            value={company} 
            key={company} 
            className="border-b border-dashed border-slate-200 dark:border-neutral-700 !py-1 !my-0 transition-colors hover:bg-accent-foreground/20 rounded-md px-1"
          >
              ...
              <div className="flex space-x-2 items-center">
                     <div className="flex items-center space-x-2">
                       ...
                       <div className="flex flex-row space-x-3 items-center">
                         <span className="text-sm group-hover:text-primary/90">{company}</span>
                         <span className="text-xs text-muted-foreground font-bold font-mono tracking-tighter">{role}</span>
                       </div>
                     </div>
                   </div>
                   <div className="flex flex-row space-x-3 items-center">
