...
Just to be clear, I'm not saying Copilot is bad. It's great, I use it every day. I'm saying it shouldn't be treated like autocomplete--the auto-suggest feature doesn't feel like the right way to use it. **I'm only talking about the auto-suggest feature.**
...
I know I'd avoid mindlessly copying code from StackOverflow if I were trying to learn a language. It feels obviously wrong from a learning perspective. *Why does Copilot feel different than this?* Since the auto-suggestions feel so natural, it doesn't feel as wrong. It makes it so easy to forget how important it is to type out the code yourself.
...
## Conclusion
These are all just my opinions (the title is a joke). Maybe try it out for yourself and see how it feels. I'd love to hear your thoughts. Thanks for reading!
